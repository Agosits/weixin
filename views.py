...
TOKEN = 'tokenforweixin'
APP_ID = 'wxe2916810a9a30626'
APP_SECRET = 'e38a7c606db6310b20d9345cee57479c'
...
def oauth(request):
    ...
    nsukey = request.GET.get('nsukey','null')
    if code != 'error':
        ...
        #user_info = 'access_token_oauth:'+access_token_oauth+'\n'+'openid_oauth:'+openid_oauth+'\n' 
        user_info = ''
